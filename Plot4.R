...
plot(EPower2$DateTime, EPower2$Voltage, type = "l", xlab = "datetime", ylab="Voltage")
with(EPower2,{plot(DateTime,Sub_metering_1, type="l", xlab = "", ylab = "Energy Sub Metering")
  lines(DateTime, Sub_metering_2, type="l", col="red")
  lines(DateTime, Sub_metering_3, type = "l", col="blue")
  legend("topright", c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"), lty=1, col=c("black", "red", "blue"))
})
plot(EPower2$DateTime, EPower2$Global_reactive_power, type = "l", xlab = "datetime", ylab="Global_reactive_power")
